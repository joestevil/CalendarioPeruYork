...
export default async function ReservarPage({ params }: { params: Promise<{ sedeId: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] text-gray-900 font-sans selection:bg-[#49369b] selection:text-white">
      <div className="container mx-auto px-4 py-8 md:px-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="bg-[#49369b] p-2 md:p-2.5 rounded-xl shadow-md border-2 border-white hover:scale-105 transition-transform cursor-default">
            <img
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-12 items-start w-full">
          ...
          {/* Left Column (Location Details) - 1/3 width with critical alignment fix padding */}
          <div className="md:col-span-1 flex flex-col gap-6 md:sticky md:top-12 md:pl-16 pl-4">
            {imageUrl && (
          ...
          <div className="md:col-span-2 w-full mt-8 md:mt-0">
            <div className="p-6 md:p-8 bg-white rounded-xl shadow-lg border border-gray-100 relative overflow-hidden">
              ...
              {isSauna ? (
                ...
                <BookingForm sedeId={sede.id} existingBookings={existingBookings} />
              )}
            </div>
          </div>
